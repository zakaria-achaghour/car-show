...
const SeachManufacture = ({manufacturer, setManufacturer}: ManufacturerProps) => {
    const [query, setQuery] = useState('');

    const filterdManufactured = 
        query === "" 
        ? manufacturers 
